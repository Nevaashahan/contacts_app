...
namespace Contacts.Maui.Models
{
    public static class ContactRepository
    {
        ...
        {
            new Contact() { ContactId = 1, Name = "John Rambo", Email = "johnrambo@gmail.com" },
            new Contact() { ContactId = 2, Name = "Hero mass", Email = "heromass@gmail.com" },
            new Contact() { ContactId = 3, Name = "Hello brou", Email = "hellobrou@gmail.com" },
            new Contact() { ContactId = 4, Name = "salam mass", Email = "salammass@gmail.com" },
        };
